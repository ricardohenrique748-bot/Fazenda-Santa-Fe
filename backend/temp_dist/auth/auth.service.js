                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, bcrypt.compare(pass, user.senha)];
                        case 2:
                            _a = (_b.sent());
                            _b.label = 3;
                        case 3:
                            if (_a) {
                                senha = user.senha, result = __rest(user, ["senha"]);
        ...
        AuthService_1.prototype.login = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    payload = { email: user.email, sub: user.id, empresaId: user.empresaId };
