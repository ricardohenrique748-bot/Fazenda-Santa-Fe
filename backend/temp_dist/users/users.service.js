...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findOne = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.usuario.findUnique({
                            where: { email: email },
        ...
        UsersService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, salt, hashedPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findOne(data.email)];
                        case 1:
                            existing = _a.sent();
                            if (existing) {
                        ...
                        case 2:
                            salt = _a.sent();
                            return [4 /*yield*/, bcrypt.hash(data.senha, salt)];
                        case 3:
                            hashedPassword = _a.sent();
                            return [2 /*return*/, this.prisma.usuario.create({
                                    data: __assign(__assign({}, data), { senha: hashedPassword }),
                                })];
                    }
                });
            });
        ...
        UsersService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(data.senha && typeof data.senha === 'string')) return [3 /*break*/, 3];
                            return [4 /*yield*/, bcrypt.genSalt()];
                        case 1:
                            salt = _b.sent();
                            _a = data;
                        ...
                        case 3:
                            ...
                            _b.label = 4;
                        case 4: return [2 /*return*/, this.prisma.usuario.update({
                                where: { id: id },
                                data: data,
                            })];
                    }
        ...
        UsersService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.usuario.delete({ where: { id: id } })];
                });
            });
        };
